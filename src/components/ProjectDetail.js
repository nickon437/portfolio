...
const ProjectDetail = (props) => {
  ...
  return (
    <div className='project-detail body-content'>
      <h1>{project.title}</h1>
      <div className='page-content project-detail-snippet'>
        {project.snippet}
      </div>
        ...
        <ul>
          {project.demo &&
            project.demo.map((illustration) => (
              <li data-name={illustration.name}>
                <img src={illustration.src} alt={illustration.name} />
              </li>
            ))}
        </ul>
      </div>
      <div className='hflex'>
        ...
        <a
          ...
          rel='noreferrer'
          className='std-btn'
          style={{ display: !project.source && 'none' }}
        >
          Visit source
        </a>
      </div>
